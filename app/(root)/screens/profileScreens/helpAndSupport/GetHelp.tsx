...
function getChannels(colors: ThemeColors) {
  return [
    {
      id: "assistant",
      icon: <Ionicons name="sparkles" size={22} color={colors.text} />,
      label: "AI Assistant",
      active: true,
    },
    {
      id: "chat",
      icon: <Ionicons name="chatbubble-ellipses" size={22} color={colors.text} />,
      label: "Live chat",
      active: true,
    },
    {
      id: "facebook",
      icon: <FontAwesome name="facebook" size={22} color={colors.infoText} />,
      label: "Facebook",
      active: false,
    },
    {
      id: "twitter",
      icon: <FontAwesome name="twitter" size={22} color={colors.infoText} />,
      label: "Twitter",
      active: false,
    },
  ];
...
export default function GetHelp() {
  ...
  const channels = useMemo(() => getChannels(colors), [colors]);
      ...
      >
        ...
        <View style={styles.heroRow}>
          <View style={styles.heroIcon}>
            <Ionicons name="headset-outline" size={rMS(28)} color={colors.onInverseSurface} />
          </View>
