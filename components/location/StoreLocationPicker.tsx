    ...
    <View style={styles.wrap}>
      ...
      <View style={styles.actionRow}>
        ...
        >
          {isLookingUp ? (
            ...
            <Ionicons name="search-outline" size={rS(18)} color={colors.onPrimary} />
          )}
        ...
        >
          {isLocating ? (
            ...
            <Ionicons name="locate-outline" size={rS(18)} color={colors.primary} />
          )}
      ...
      {hasPin ? (
        <View style={styles.successCard}>
          <Ionicons name="checkmark-circle" size={rS(22)} color={colors.successText} />
